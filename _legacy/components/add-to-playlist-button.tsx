...
export function AddToPlaylistButton({ tmdbId, mediaType, title, posterPath, className }: AddToPlaylistButtonProps) {
  const { user } = useAuth()
  ...
  const handleAddToPlaylist = async (playlistId: string) => {
    ...
    const success = await addToPlaylist(playlistId, tmdbId, mediaType, title, posterPath)
