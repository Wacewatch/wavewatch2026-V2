...
interface AnimeEpisodePageProps {
  params: Promise<{
    id: string
    season: string
    episode: string
...
export default async function AnimeEpisodePage({ params }: AnimeEpisodePageProps) {
  ...
  try {
    ...
    // Récupérer les détails de l'animé et de la saison
    ...
    console.error("Error fetching anime episode details:", error)
    notFound()
  }
}
