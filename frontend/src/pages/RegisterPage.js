...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-[90vh] text-white" style={{ background: 'linear-gradient(180deg, hsl(var(--background)) 0%, hsl(var(--card)) 35%, hsl(var(--background)) 100%)' }} data-testid="register-page">
